...
One game inside the [segagame](../) monorepo - see the top-level README for how
this folder relates to other games built here.

Design brief: [docs/planning.md](docs/planning.md). Picking this project back up after
a break, or handing it to a different AI/developer? Start with
...
- **Match**: full dodgeball gameplay -
  ...
  - **A/B/C** always throw to the left corner/back middle/right corner; hold Left or Right for spin.
  - A player is hit only when the visible flight path crosses their body; enough spin can bend clear.
...
├── assets/         Source art (pre-conversion reference images)
├── tools/          Python/PowerShell art-to-ROM tile pipeline scripts
├── docs/           Design notes + AI-session handover doc
